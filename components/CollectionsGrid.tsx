...
const tiles = [
  { slug: "winter", label: "Winter Collection 2026", seed: "grid-winter", span: "md:col-span-2 md:row-span-2" },
  { slug: "men", label: "Men’s Collection", seed: "grid-men", span: "" },
  { slug: "ladies", label: "Ladies Collection", seed: "grid-ladies", span: "" },
  { slug: "kids", label: "Kids Collection", seed: "grid-kids", span: "" },
];
      ...
      {tiles.map((t, i) => (
        ...
        >
          <Link href={`/collections/${t.slug}`} className="group block h-full w-full relative overflow-hidden bg-canvas">
            <Image
              src={`https://picsum.photos/seed/${t.seed}/1000/1000`}
              alt={t.label}
              fill
